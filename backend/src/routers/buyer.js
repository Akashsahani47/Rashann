...
// List all shopkeepers, optional filters
...
router.get('/shopping-lists/last', auth, async (req, res) => {
  try {
...
router.get('/shopping-lists/:month', auth, async (req, res) => {
  try {
...
router.put('/shopping-list/:id', auth, async (req, res) => {
  try {
...
router.post('/shopping-list/:id/share', auth, async (req, res) => {
  try {
...
router.get('/ledger/:shopkeeperId', auth, async (req, res) => {
  try {
